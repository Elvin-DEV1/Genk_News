...
class RelatedNewsCategoryAdapter : RecyclerView.Adapter<RelatedNewsCategoryAdapter.ViewHolder>() {

    /* **********************************************************************
     * DiffUtil
     ********************************************************************** */
    private val differCallback = object : DiffUtil.ItemCallback<NewsCategoryRelation>() {
        override fun areItemsTheSame(
            oldItem: NewsCategoryRelation,
            newItem: NewsCategoryRelation
        ): Boolean {
    ...
    fun submitList(list: List<NewsCategoryRelation>) {
     ...
     * Click Listener
     ********************************************************************** */
    private var onItemClickListener: ((NewsCategoryRelation) -> Unit)? = null

    fun setOnItemClickListener(listener: (NewsCategoryRelation) -> Unit) {
